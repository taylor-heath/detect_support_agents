...
## REFERENCE LIST — VARIANTS FOR POTENTIAL BLOCKING

Replication of the 23 brands on the Supreme Court blocked-site list, compiled from the denuncias of
28-08-2026 and 14-09-2026. 76 domains across 23 brands. Primaries already on the blocked list are
excluded; `www.` duplicates and redirect targets sharing a registrable domain are collapsed.

Terminology note (Rule 1): the source table records these under a gambling `Status` value carrying a
legality label. That label is not reproduced here and no assessment of licensing or lawfulness is
made or should be inferred. "Blocked-site list" describes a list supplied by the client.

Priorities follow Rule 3 market relevance: **P1** carries an explicit `TARGET_MARKET` marker,
**P2** a generic suffix reachable from the target market, **P3** another market's ccTLD or currency
marker.
...
|---|---|---|
| 1xbet1.cl | 1xBet | `.cl` |
| chile.1xbet.com | 1xBet | `chile` subdomain |
| 1xbetchil.com | 1xBet | truncated `chil` |
| coolbetchile.com | Coolbet | `chile` |
| coolbetchile.info | Coolbet | `chile` |
| coolbetchile.net | Coolbet | `chile` |
| coolbetchile.top | Coolbet | `chile` |
| lat.betano.com | Betano | `lat` |
| latam.betano.com | Betano | `latam` |
| betplay-chile.com | BetPlay | `chile` |
| betonwinchile.app | Betsala | `chile` |
| betssonchile.cl | Betsson | `chile` + `.cl` |
| betsson1002.com | Betsson | serves `/cl` path |
| marathonbet.cl | Marathonbet | `.cl` |
| micasinocl.com | Mi Casino | `cl` marker |
| micasinoscl.com | Mi Casino | `cl` marker |
| micasinochileoficial.com | Mi Casino | `chile` |
| juegaenlineachile.com | Juega en Linea | `chile` |
| juegaenlineachile.bet | Juega en Linea | `chile` |
| juegaenlineachile.net | Juega en Linea | `chile` |
| juegaenlineachile.org | Juega en Linea | `chile` |
| rivalo-chile.com | Rivalo | `chile` |
| rojabet.cl | RojaBet | `.cl` |
| estelar-bet.cl | Estelarbet | `.cl` |
| latamwin-cl.cl | Latamwin | `latam` + `.cl` |
| latamwin.online | Latamwin | `latam` |
| bodog-cl.com | Bodog | `cl` marker |
| clbetfair.com | Betfair | `cl` prefix |

### P2 — Block

| Domain | Brand | Pattern |
|---|---|---|
| bet36.com | Bet365 | typosquat |
| bet36fifa.com | Bet365 | brand token + affix |
| bet362.vip | Bet365 | numbered |
| bet363.app | Bet365 | numbered |
| bet363.bet | Bet365 | numbered |
| bet365bonus.com | Bet365 | brand + affix |
| loginbet365.com | Bet365 | brand + affix |
| officialbet365.com | Bet365 | brand + affix |
| apuestacoolbet.com | Coolbet | brand + Spanish affix |
| betsala.app | Betsala | TLD rotation |
| betsala.bet | Betsala | TLD rotation |
| betsala11.com | Betsala | numbered |
| m.betsala11.com | Betsala | mobile subdomain |
| betsalavip.com | Betsala | brand + affix |
| m.betsalavip.com | Betsala | mobile subdomain |
| mobile.betsala.com | Betsala | mobile subdomain |
| betzala.com | Betsala | typosquat |
| betsson1001.com | Betsson | numbered |
| betsson-casinoo.it.com | Betsson | brand + affix |
| betwarrior.bet | BetWarrior | TLD variant |
| micasinoenvivo.com | Mi Casino | brand + affix |
| rojabet2.com | RojaBet | numbered |
| blog.rojabet.com | RojaBet | subdomain |
| estelar.bet | Estelarbet | split-brand TLD |
| be.betcris.com | Betcris | subdomain |
| blog.betway.com | Betway | subdomain |

### P3 — Monitor

| Domain | Brand | Market |
|---|---|---|
| 1xbetargentina.casino | 1xBet | AR |
| betsson.bet.ar | Betsson | AR |
| betwarrior.bet.ar | BetWarrior | AR |
| betcris.mx | Betcris | MX |
| be.betcris.mx | Betcris | MX |
| betnbet.mx | Betcris | MX |
| betcris.pe | Betcris | PE |
| betsson.co | Betsson | CO |
| offers.betsson.co | Betsson | CO |
| ofertas.betsson.pe | Betsson | PE |
| betway.es | Betway | ES |
| betway.mx | Betway | MX |
| betway.de | Betway | DE |
| betway.co.za | Betway | ZA |
| new.betway.co.za | Betway | ZA |
| bwin.es | bwin | ES |
| bet365.es | Bet365 | ES |
| kto.bet.br | KTO | BR |
| marathonbet.es | Marathonbet | ES |
| rivalo.co | Rivalo | CO |
| rushbet.co | Rushbet | CO |
| rushbet.es | Rushbet | ES |

### Held out of the list

`aguasanjoaquin.cl` appears under Latamwin in the source table but is a Chilean water utility
domain. Per Rule 5 (parasite hosting), it indicates compromise or paid placement rather than
operator-owned property, and blocking it would take down an unrelated service. It needs a
notification and takedown route, not a block order.

### Open items

- **Subdomain redundancy.** `be.betcris.com`, `blog.betway.com`, `blog.rojabet.com`,
  `mobile.betsala.com` and `chile.1xbet.com` sit under registrable domains already on the blocked
  list. Whether they need separate listing depends on whether the ISP block operates at registrable-
  domain or FQDN level. Confirm before submission — listing them unnecessarily weakens it.
- **Predictable successors.** Betsson moved 1001 → 1002 between the two denuncia dates; Betsala is
  on `betsala11`; Bet365 has `bet362` and `bet363` live. Per Rule 3 Step 7, check `betsson1003`,
  `betsala12` and `bet364` for resolution now rather than after the next ruling. These are
  unverified predictions and must resolve before being submitted.
