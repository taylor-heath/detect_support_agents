...
| Item | Detail |
|---|---|
| Purpose of report | *[One sentence]* |
| Scope of monitoring | *[Platforms, jurisdictions, date range]* |
| Total URLs classified | *[n]* |
| Confirmed / actionable | *[n]* |
| Pending review | *[n]* |
| Dismissed / false positive | *[n]* |
| Dominant subcategory | *[e.g. Baccarat]* |
| Mean confidence score | *[0.00]* |
| Key finding 1 | *[Statement]* |
| Key finding 2 | *[Statement]* |
| Key finding 3 | *[Statement]* |
...
| Item | Detail |
|---|---|
| Background | *[Why this monitoring exists]* |
| Objective | *[What the report sets out to establish]* |
| Scope — in | *[Platforms, categories, languages, territories covered]* |
| Scope — out | *[What was deliberately excluded]* |
| Data source | SICPADetect automated classification output |
| Collection window | *[DD/MM/YYYY – DD/MM/YYYY]* |
| Intended audience | *[Regulator / internal compliance / client]* |
| Limitations | *[Known gaps, sampling constraints, platform access limits]* |
...
| Subcategory | Count | % of total | Mean confidence |
|---|---|---|---|
| *[Baccarat]* | *[ ]* | *[ ]* | *[ ]* |
| *[Slots]* | *[ ]* | *[ ]* | *[ ]* |
| *[Casino — general]* | *[ ]* | *[ ]* | *[ ]* |
...
### 3.3 By confidence band

| Confidence band | Count | Handling |
|---|---|---|
| High (≥ 0.90) | *[ ]* | *[Auto-accept / escalate]* |
| Medium (0.70 – 0.89) | *[ ]* | *[Human review]* |
| Low (< 0.70) | *[ ]* | *[Manual adjudication]* |

### 3.4 By source

| Source where URL was found | Count | Notes |
|---|---|---|
| *[X / Twitter]* | *[ ]* | *[ ]* |
| *[Facebook]* | *[ ]* | *[ ]* |
| *[Search engine result]* | *[ ]* | *[ ]* |
| *[Referral / third-party report]* | *[ ]* | *[ ]* |
